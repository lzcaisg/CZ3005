...
nation(Marit_Bjørgen, Norway).
nation(Nikolai_Andrianov, Soviet_Union).
nation(Ole_Einar_Bjørndalen, Norway).
...
nation(Věra_Čáslavská, Czechoslovakia).
sport(Michael_Phelps, Swimming).
sport(Larisa_Latynina, Gymnastics).
sport(Marit_Bjørgen, Cross-country_skiing).
sport(Nikolai_Andrianov, Gymnastics).
sport(Ole_Einar_Bjørndalen, Biathlon).
...
sport(Bjørn_Dæhlie, Cross-country_skiing).
...
sport(Věra_Čáslavská, Gymnastics).
start_year(Michael_Phelps, 2004).
start_year(Larisa_Latynina, 1956).
start_year(Marit_Bjørgen, 2002).
start_year(Nikolai_Andrianov, 1972).
start_year(Ole_Einar_Bjørndalen, 1998).
...
start_year(Věra_Čáslavská, 1960).
end_year(Michael_Phelps, 2016).
end_year(Larisa_Latynina, 1964).
end_year(Marit_Bjørgen, 2018).
end_year(Nikolai_Andrianov, 1980).
end_year(Ole_Einar_Bjørndalen, 2014).
...
end_year(Věra_Čáslavská, 1968).
season(Michael_Phelps, Summer).
season(Larisa_Latynina, Summer).
season(Marit_Bjørgen, Winter).
season(Nikolai_Andrianov, Summer).
season(Ole_Einar_Bjørndalen, Winter).
...
silver_no(Věra_Čáslavská, 4).
bronze_no(Michael_Phelps, 2).
bronze_no(Larisa_Latynina, 4).
bronze_no(Marit_Bjørgen, 3).
bronze_no(Nikolai_Andrianov, 3).
bronze_no(Ole_Einar_Bjørndalen, 1).
...
bronze_no(Věra_Čáslavská, 0).
total_no(Michael_Phelps, 28).
total_no(Larisa_Latynina, 18).
total_no(Marit_Bjørgen, 15).
total_no(Nikolai_Andrianov, 15).
total_no(Ole_Einar_Bjørndalen, 13).
